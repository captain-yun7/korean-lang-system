...
export default function NewExamPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || '시험 등록에 실패했습니다.');
      }
      ...
      setError(err.message || '시험 등록에 실패했습니다.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">새로운 시험을 만들어 학생들에게 배정하세요</p>
      </div>
